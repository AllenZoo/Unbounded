...
/// </summary>
[Serializable]
public class ProjectileAttacker: BaseAttacker<ProjectileAttackerData>
{
    ...
    public ProjectileAttacker(ProjectileAttackerData attackerData, AttackData attackData)
    {
    ...
    // does nothing.
    public override void Attack(KeyCode keyCode, AttackerContext ac)
    {
    ...
    {
        ProjectileAttackerData clonedAttackerData = UnityEngine.Object.Instantiate(attackerData);
