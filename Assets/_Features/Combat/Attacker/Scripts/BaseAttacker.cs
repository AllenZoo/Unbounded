...
public abstract class BaseAttacker<T>: IAttacker, IAttackNode where T: ProjectileAttackerData
{
    ...
    public abstract void Attack(KeyCode keyCode, AttackerContext attackContext);
