...
public class FileDataHandler
{
    ...
    /// <summary>
    /// Attempts to load data from specified profile. If profile doesn't exist, this function returns null.
    /// </summary>
    ...
    public void Save(GameData data, string profileId)
    {
        ...
        Debug.Log($"Save file path is {fullPath}");
    ...
    /// </summary>
    /// <returns>A map of [profileId, profileData]</returns>
