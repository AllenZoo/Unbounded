...
public class PauseManager : Singleton<PauseManager>
{
    ...
    [SerializeField] private PlayerIntent playerInput; // Coupled with player input to allow disabling it. Should be fine to couple this logic since they will both always exist in persistent gameplay (or should, will add guards).
